...
class AdminServerForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'flags': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Индивидуальные флаги'}),
            'immunity': forms.NumberInput(attrs={'class': 'form-control', 'placeholder': 'Индивидуальный иммунитет'}),
        }
